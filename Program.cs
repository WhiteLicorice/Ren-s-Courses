...
public static class WebsiteKeys
{
    ...
    public const string BlogLead = "This is a collection of materials for CS courses under the University of the Philippines Visayas, Division of Physical Sciences and Mathematics.";
}
