...
- Verification path: delete `artifacts/pdf-toolchain`, `artifacts/tectonic-cache`, `artifacts/material-pdfs`, and `wwwroot/generated-pdfs`, then run the documented production `dotnet run --no-launch-profile --configuration Release`. On 2026-07-14 the cold run generated all 41 PDFs with zero fallbacks in about 106 seconds; an unchanged warm run reported 41 cache hits in 0.14 seconds. The final gates passed 161 .NET tests, 111 Jest tests, 7 Python tests, and 17 Chromium material-page tests.
